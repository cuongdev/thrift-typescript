    ...
    switch (node.value.type) {
        case thrift_parser_1.SyntaxType.IntegerLiteral:
            if (fieldType && fieldType.type === thrift_parser_1.SyntaxType.I64Keyword) {
                return ts.createCall(ts.createPropertyAccess(identifiers_1.COMMON_IDENTIFIERS.Int64, ts.createIdentifier('fromDecimalString')), undefined, [ts.createLiteral(node.value.value)]);
            }
            else {
        ...
        case thrift_parser_1.SyntaxType.HexLiteral:
            if (fieldType && fieldType.type === thrift_parser_1.SyntaxType.I64Keyword) {
                return ts.createNew(identifiers_1.COMMON_IDENTIFIERS.Int64, undefined, [
...
function renderSet(fieldType, node, state) {
    const values = node.elements.map((value) => {
