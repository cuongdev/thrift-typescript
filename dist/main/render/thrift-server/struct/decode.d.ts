...
export declare function createTempVariables(node: InterfaceWithFields): Array<ts.VariableStatement>;
export declare function createDecodeMethod(node: InterfaceWithFields, state: IRenderState): ts.MethodDeclaration;
export declare function createInputParameter(): ts.ParameterDeclaration;
export declare function createCheckForFields(fields: Array<FieldDefinition>): ts.BinaryExpression;
...
export declare function createReturnForStruct(node: InterfaceWithFields, state: IRenderState): ts.Statement;
export declare function readValueForIdentifier(id: string, definition: DefinitionType, fieldType: FunctionType, fieldName: ts.Identifier, state: IRenderState): Array<ts.Statement>;
